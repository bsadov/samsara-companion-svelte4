...
<div class='map'>
    {#if $storedcurrent.coordinates == null}
        <a href='https://www.google.com/maps/search/?api=1&query={$storedcurrent.name}+{$storedcurrent.location}' target='_blank'><img src='%sveltekit.assets%/placeholder.jpg' alt='placeholder'><br>click for full map (new tab)</a>
    {:else}
